import {
  ...
  // Função para carregar a lista de clientes na página
  function carregarClientes() {
    let selectCliente = document.getElementById("cliente-venda");
  ...
  function abrirModalFinalizarVenda() {
    let cliente = document.getElementById("cliente-venda").value;
    ...
    modal.innerHTML = `
      <div class="modal-content">
        ...
        <p class="modal-text">Você deseja finalizar a venda para ${
